...
namespace PodioPCL.Services
{
	...
	public class SpaceMembersService
	{
		...
		public Task<SpaceMember> GetSpaceMember(int spaceId, int userId)
		{
			...
			return _podio.GetAsync<SpaceMember>(url);
		}
		...
		/// <returns>Task&lt;List&lt;SpaceMember&gt;&gt;.</returns>
		public Task<List<SpaceMember>> GetSpaceMembers(int spaceId, string memberType = null, string query = null, int limit = 100, int offset = 0)
		{
			...
			return _podio.GetAsync<List<SpaceMember>>(url, requestData);
		}
		...
		/// </summary>
		/// <param name="spaceId"></param>
		public Task LeaveSpace(int spaceId)
		{
		...
		/// <param name="spaceId">The space identifier.</param>
		/// <returns>Task.</returns>
		public Task RequestSpaceMembership(int spaceId)
		{
		...
		/// </summary>
		/// <param name="spaceId">The space identifier.</param>
		/// <param name="spaceMemberRequestId">The space member request identifier.</param>
		/// <returns>Task.</returns>
		public Task AcceptSpaceMembershipRequest(int spaceId, int spaceMemberRequestId)
		{
		...
		/// </summary>
		/// <param name="spaceId">The space identifier.</param>
		/// <param name="addSpaceMemberRequest">The add space member request.</param>
		/// <returns>Task.</returns>
		public Task AddMemberToSpace(int spaceId, AddSpaceMemberRequest addSpaceMemberRequest)
		{
			string url = string.Format("/space/{0}/member/", spaceId);
			return _podio.PostAsync<dynamic>(url, addSpaceMemberRequest);
		}
		...
		/// <param name="userIds">The user ids.</param>
		/// <returns>Task.</returns>
		public Task EndSpaceMemberships(int spaceId, int[] userIds)
		{
