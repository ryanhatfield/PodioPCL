...
namespace PodioPCL.Services
{
    ...
    public class CalendarService
    {
        ...
        /// <returns></returns>
        public IEnumerable<CalendarEvent> GetAppCalendar(int appId, DateTime dateFrom, DateTime dateTo, int? priority = null)
        {
        ...
        /// <param name="priority">The minimum priority for the events to return Default value: 1</param>
        /// <returns></returns>
        public IEnumerable<CalendarEvent> GetSpaceCalendar(int spaceId, DateTime dateFrom, DateTime dateTo, int? priority = null)
        {
