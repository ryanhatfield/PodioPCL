...
namespace PodioPCL.Services
{
	...
	public class OrganizationService
	{
		...
		public async Task AddOrganizationAdmin(int organizationId, int userId)
		{
			...
			await _podio.PostAsync<dynamic>(url, requestData);
		}
		...
		/// <param name="organizationId">The organization identifier.</param>
		/// <returns>Task.</returns>
		public async Task DeleteOrganizationAppStoreProfile(int organizationId)
		{
			string url = string.Format("/org/{0}/appstore", organizationId);
		...
		/// <returns>Task.</returns>
		public async Task DeleteOrganizationMemberRole(int organizationId, int userId)
		{
		...
		/// <returns>Task&lt;List&lt;OrganizationMember&gt;&gt;.</returns>
		public async Task<List<OrganizationMember>> GetMembers(int organizationId, string memberType = null, string query = null, int? limit = null, int? offset = null, string sortBy = null, bool sortDesc = false)
		{
			...
			return await _podio.GetAsync<List<OrganizationMember>>(url, requestData);
		}
		...
		/// </summary>
		/// <returns>Task&lt;List&lt;Organization&gt;&gt;.</returns>
		public async Task<List<Organization>> GetOrganizations()
		{
			string url = "/org/";
			return await _podio.GetAsync<List<Organization>>(url);
		}
		...
		public async Task<Organization> GetOrganization(int organizationId)
		{
			...
			return await _podio.GetAsync<Organization>(url);
		}
		...
		/// </summary>
		/// <param name="orgUrl">The org URL.</param>
		/// <returns>Task&lt;Organization&gt;.</returns>
		public async Task<Organization> GetOrganizationByURL(string orgUrl)
		{
			...
			return await _podio.GetAsync<Organization>(url, requestData);
		}
		...
		{
			string url = string.Format("/org/{0}/admin/", organizationId);
			return await _podio.GetAsync<List<User>>(url);
		}
		...
		/// <returns>Task&lt;List&lt;OrganizationLoginReport&gt;&gt;.</returns>
		public async Task<List<OrganizationLoginReport>> GetOrganizationLoginReport(int organizationId, int limit = 4, int offset = 0)
		{
			...
			return await _podio.GetAsync<List<OrganizationLoginReport>>(url, requestData);
		}
		...
		public async Task<List<Space>> GetSpacesOnOrganization(int organizationId)
		{
			...
			return await _podio.GetAsync<List<Space>>(url);
		}
		...
		/// <param name="userId">The user identifier.</param>
		/// <returns>Task.</returns>
		public async Task RemoveOrganizationAdmin(int organizationId, int userId)
		{
		...
		/// <returns>Task.</returns>
		public async Task UpdateOrganizationAppStoreProfile(int organizationId, Contact profileData)
		{
			string url = string.Format("/org/{0}/appstore", organizationId);
		...
		/// <param name="organizationId">The organization identifier.</param>
		/// <param name="userId">The user identifier.</param>
		/// <returns>Task&lt;List&lt;SpaceMember&gt;&gt;.</returns>
		public async Task<List<SpaceMember>> GetSpaceMembershipsForOrgMember(int organizationId, int userId)
		{
			...
			return await _podio.GetAsync<List<SpaceMember>>(url);
		}
