...
namespace PodioPCL.Services
{
    public class ConversationService
    {
        ...
        /// <param name="conversationCreateRequest"></param>
        /// <returns></returns>
        public Conversation CreateConversationOnObject(string refType, int refId, ConversationCreateRequest conversationCreateRequest)
        {
        ...
        /// <returns></returns>
        public ConversationEvent ReplyToConversation(int converstionId, string text, List<int> fileIds = null, int? embedId = null, string embedUrl = null)
        {
        ...
        /// <returns></returns>
        public List<Conversation> SearchConversations(string text, int limit = 10, int offset = 0, bool participants = false)
        {
